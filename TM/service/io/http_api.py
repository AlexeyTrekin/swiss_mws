...
class HttpApi:
            ...
            # Awful mess! Clean it... maybe, make all inside the fights, with 'conducted' flag
                ...
                for p in self.area_pairs(area):
                    for fight in self.fights:
                        if (fight.fighter_1, fight.fighter_2) == p or (fight.fighter_2, fight.fighter_1) ==p:
                            continue
    ...
    def check_results(self):
        ...
        for fight in self.fights:
            if (fight.fighter_1, fight.fighter_2) not in self.pairs and \
                    (fight.fighter_2, fight.fighter_1) not in self.pairs:
                return False
        return True
